    ...
    for each_sent in randomized_Sentence:
        if trainingCounter >= 0:
            for each_letter in each_sent:
                cur.execute(
                    " INTO ParsedDocument(DocName, UnDiacritizedCharacter,DiacritizedCharacter,LetterType,"
                    "SentenceNumber, "
                    "Word, "
